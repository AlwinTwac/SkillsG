                ...
                <div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8">
                        ...
                        <form onSubmit={handleAchievementSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-black mb-1">Description</label>
                                <textarea
                            ...
                            <button type="submit" disabled={uploadingAchievement} className="px-5 py-2 bg-amber-500 text-white dark:text-black rounded-lg hover:bg-amber-600 disabled:opacity-70">
                                {uploadingAchievement ? 'Submitting...' : 'Submit for Approval'}
                            </button>
                        </form>
                    </div>

                    <h4 className="text-lg font-semibold text-gray-800 dark:text-black  mb-4">Your Submissions</h4>
                    <div className="space-y-4">
                        ...
                        <div key={ach.id} className="border p-4 rounded-lg flex items-center justify-between">
                            ...
                            <div>
                                <p className="font-medium text-black dark:text-black">{ach.description}</p>
                                <span className={`text-xs font-semibold text-black px-2 py-0.5 rounded-full ${
